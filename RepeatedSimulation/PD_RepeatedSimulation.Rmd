...
setwd("/Volumes/GoogleDrive/Shared drives/RSSC Lab/Current Studies/MPT reliability/RepeatedSim/PDRepeated/")
...
for(t in 1:2){
  ...
  for(d in 1:length(timeList)){
    ...
    write.csv(PDdf, paste0("./",curName,"/",curName,".Num",n,".Sim.csv"))
    }
  }
}
```
...
curDirs <- list.dirs("/Volumes/GoogleDrive/Shared drives/RSSC Lab/Current Studies/MPT reliability/RepeatedSim/PDRepeated/", recursive = F)
...
write.csv(countAssoc, "~/Documents/GitHub/MPT-Reliability/RepeatedSimulation/output/PDSpearmanCors.csv",row.names = F)
...
write.csv(trueAssocMean, "~/Documents/GitHub/MPT-Reliability/RepeatedSimulation/output/PDTrueCorMeans.csv",row.names = F)
...
write.csv(trueAssocSD, "~/Documents/GitHub/MPT-Reliability/RepeatedSimulation/output/PDTrueCorSD.csv",row.names = F)
```
